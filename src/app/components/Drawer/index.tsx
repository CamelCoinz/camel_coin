...
interface SideDrawerProps {
  ...
  handleNavItemClick: CallableFunction;
}
...
const SideDrawer: FC<SideDrawerProps> = ({
  ...
  return (
    <>
      ...
      <div
        className={`fixed top-0 right-0 h-full w-64 bg-[#FBDBA4] z-50 transform ${
          ...
          <ul className="space-y-2">
            <li
              ...
              className={`flex items-center gap-3 px-4 py-2 cursor-pointer font-bold ${
                activeSection === "#token-price" && "active__drawer"
              }`}
            >
              <svg
                width="20"
              ...
              >
                <path
                  ...
                  fill={activeSection === "#token-price" ? "white" : "#B37337"}
                />
              </svg>
              <Link
                className={
                  activeSection === "#token-price" ? "" : "text-[#B37337]"
                }
                href="#token-price"
              >
                Token Price
            ...
            <li
              ...
              className={`flex items-center gap-3 px-4 py-2 cursor-pointer font-bold ${
                activeSection === "#tokenomics" && "active__drawer"
              }`}
            >
              <svg
                width="20"
              ...
              >
                <path
                  ...
                  fill={activeSection === "#tokenomics" ? "white" : "#B37337"}
                />
              </svg>
              <Link
                className={
                  activeSection === "#tokenomics" ? "" : "text-[#B37337]"
                }
                href="#tokenomics"
              >
                Tokenomics
            ...
            <li
              ...
              className={`flex items-center gap-3 px-4 py-2 cursor-pointer font-bold ${
                activeSection === "#who-is" && "active__drawer"
              }`}
            >
              <svg
                width="20"
              ...
              >
                <path
                  ...
                  fill={activeSection === "#who-is" ? "white" : "#B37337"}
                />
              </svg>
              <Link
                className={activeSection === "#who-is" ? "" : "text-[#B37337]"}
                href="#who-is"
              >
                Who is
              </Link>
            ...
            <li
              ...
              className={`flex items-center gap-3 px-4 py-2 cursor-pointer font-bold ${
                activeSection === "#future" && "active__drawer"
              }`}
            >
              <svg
                width="20"
              ...
              >
                <path
                  ...
                  fill={activeSection === "#future" ? "white" : "#B37337"}
                />
              </svg>
              <Link
                className={activeSection === "#future" ? "" : "text-[#B37337]"}
                href="#future"
              >
                Future
              </Link>
            ...
            <li
              ...
              className={`flex items-center gap-3 px-4 py-2 cursor-pointer font-bold ${
                activeSection === "#roadmap" && "active__drawer"
              }`}
            >
              <svg
                width="20"
                height="20"
                viewBox="0 0 45 49"
                fill={activeSection === "#roadmap" ? "white" : "#B37337"}
                xmlns="http://www.w3.org/2000/svg"
              >
              ...
              <Link
                className={activeSection === "#roadmap" ? "" : "text-[#B37337]"}
                href="#roadmap"
              >
                Roadmap
              </Link>
